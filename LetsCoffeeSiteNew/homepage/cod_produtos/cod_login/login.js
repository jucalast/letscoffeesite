function authenticateUser() {
    ...
    if (username === clienteLogin && password === clienteSenha) {
        window.location.href = '../cod_gerenciament/dashboard.html'; // Redireciona para a interface do cliente
    } else if (username === comercianteLogin && password === comercianteSenha) {
        window.location.href = '../cod_gerenciament/dashboard.html'; // Redireciona para a interface do comerciante
    } else {
